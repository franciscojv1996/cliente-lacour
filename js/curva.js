function curva() {
  ...
  if (piezaA >= 100) {
    ...
    console.log(
      "total de piezas " + sumaA + "   total de piezas " + adultosuma
    );
  ...
  if (adulto() == 1 && piezaA == 0) {
    alert(
      " Debes de agregar la cantidad de piezas a producir de talla adulto "
    );
  ...
  if (piezaJ >= 100) {
    ...
    console.log(
      "total de piezas " + sumaJ + "   total de piezas " + juvenilsuma
    );
  ...
  if (juvenil() == 1 && piezaJ == 0) {
    alert(
      " Debes de agregar la cantidad de piezas a producir de talla juvenil "
    );
  ...
  if (piezaIM > 0) {
    ...
    var infantilMsuma =
      ...
      parseInt(resM24);
    console.log(
      "total de piezas " + sumaIM + "   total de piezas " + infantilMsuma
    );
  ...
  if (meses() == 1 && piezaIM == 0) {
    alert(
      " Debes de agregar la cantidad de piezas a producir de talla infantil "
    );
  ...
  if (piezaID >= 100) {
    ...
    var infantilDsuma =
      ...
      parseInt(resT1011);
    console.log(
      "total de piezas " + sumaID + "   total de piezas " + infantilDsuma
    );
  ...
  if (piezaIC > 0) {
    ...
    var infantilCsuma =
      ...
      parseInt(resT10);
    console.log(
      "total de piezas " + sumaIC + "   total de piezas " + infantilCsuma
    );
